...
class OneMonthFeedbackForm(FlaskForm):
    ...
    satisfaction_1to5 = fields.RadioField('How satisified were you with the survey overall? (1: least, to 5: most)*',
                                          ...
                                          validators=[Required()])
    survey_video_1to5 = fields.RadioField('How useful have you found the survey video? (1: not at all, to 5: very)*',
                                          widget=OneToFiveWidget(),
                                          choices=choices_1_to_5,
                                          validators=[Required()])
    surveyor_conduct_1to5 = fields.RadioField('How was the conduct of the surveyor? (1: poor, to 5: excellent)*',
                                              ...
                                              choices=choices_1_to_5,
                                              validators=[Required()])
    cheese_box_1to5 = fields.RadioField('How useful did you find the CHEESE box? (if applicable, 1: least, to 5: most)',
                                        widget=OneToFiveWidget(),
                                        choices=choices_1_to_5,
                                        validators=[Optional()])
    survey_value_1to5 = fields.RadioField('Was the survey good value for money? (if applicable, 1: disagree, to 5: agree)',
                                          widget=OneToFiveWidget(),
                                          choices=choices_1_to_5,
                                          validators=[Optional()])
